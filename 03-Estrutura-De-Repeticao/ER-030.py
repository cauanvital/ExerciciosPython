# O Sr. Manoel Gomes acaba de adquirir uma panificadora e pretende implantar a metodologia da tabelinha, que já é um
...
preco = 0
valoruni = float(input("Insira o valor da unidade de pão:   "))
