# João Papa-de-Pescador, homem de bem, comprou um microcomputador para controlar o rendimento diário de seu trabalho.
...
# leia a variável peso (peso de peixes) e calcule o excesso. Gravar na variável excesso a quantidade de
...
multa = exc * 4
if peso <= 50:
    print("Peso dentro do permitido. Tenha um bom dia!")
else:
    print(f"Você pescou {exc:.1f}kg a mais e deve pagar R${multa:.2f}")
